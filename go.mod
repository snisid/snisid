module github.com/snisid/platform
...
replace google.golang.org/genproto v0.0.0-20210624195500-8bfb893ecb84 => google.golang.org/genproto v0.0.0-20240903143218-8af14fe29dc1
